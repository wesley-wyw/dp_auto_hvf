...
from aikose_estimator import build_adaptive_preference_matrix
...
# AIKOSE implementation
print("正在调用 AIKOSE 模块自动计算动态阈值...")
P, dynamic_taus = build_adaptive_preference_matrix(R)

print(f"各模型的动态阈值: {np.round(dynamic_taus, 3)}")
